...
| --- | ---: | --- | --- |
| flange_adapter | 0.160 | `[0.062, 0.062, 0.018]` | `[0.000, 0.000, 0.000]` |
| palm | 0.110 | `[0.056, 0.030, 0.026]` | `[0.040, 0.000, 0.000]` |
| upper_finger | 0.035 | `[0.058, 0.008, 0.012]` | `[0.080, 0.024, 0.000]` |
| upper_yarn_hook | 0.010 | `[0.020, 0.026, 0.012]` | `[0.112, 0.024, 0.000]` |
| lower_finger | 0.035 | `[0.058, 0.008, 0.012]` | `[0.080, -0.024, 0.000]` |
| lower_yarn_hook | 0.010 | `[0.020, 0.026, 0.012]` | `[0.112, -0.024, 0.000]` |
...
| --- | --- |
| 总质量 | `0.360 kg` |
| 质心 | `[0.034, 0.000, 0.000] m` |
| `Ixx` | `0.00012444 kg*m^2` |
| `Iyy` | `0.00057061 kg*m^2` |
| `Izz` | `0.00067185 kg*m^2` |
